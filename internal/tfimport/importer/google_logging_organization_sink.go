...
// LoggingOrgSink defines a struct with the necessary information for a google_container_cluster to be imported.
...
func (b *LoggingOrgSink) ImportID(rc terraform.ResourceChange, pcv ProviderConfigMap) (string, error) {
	...
	return fmt.Sprintf("organizations/%v/sinks/%v", orgID, name), nil
}
