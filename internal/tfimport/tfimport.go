...
var importers = map[string]resourceImporter{
	...
	"google_compute_subnetwork_iam_policy":   &importer.SimpleImporter{Fields: []string{"subnetwork"}, Tmpl: "{{.subnetwork}}"},
	"google_compute_subnetwork_iam_binding":  &importer.SimpleImporter{Fields: []string{"subnetwork", "role"}, Tmpl: "{{.subnetwork}} {{.role}}"},
	"google_compute_subnetwork_iam_member":   &importer.SimpleImporter{Fields: []string{"subnetwork", "role", "member"}, Tmpl: "{{.subnetwork}} {{.role}} {{.member}}"},
