...
template "org_policies" {
  recipe_path = "{{$base}}/org_policies.hcl"
  output_path = "./live"
  data = {
...
template "kubernetes" {
  recipe_path = "{{$base}}/terraform_deployment.hcl"
