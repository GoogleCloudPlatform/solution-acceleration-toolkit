...
var (
	...
	showUnmanaged = flag.Bool("show_unmanaged_files", false, "Whether to show unmanaged files in the output directory that were not generated by tfengine. Will not delete them.")
